...
const initGame = (button, clickedLetter) => {
    // clickedLetter checks if a letter is in currentWord
    if(currentWord.includes(clickedLetter)) {
        // shows the letters on the word display
        ...
        // If a letter is not found, then go up by 1 and also change the image
        wrongGuessCount++;
        hangmanImage.src = `./img/hangman-${wrongGuessCount}.svg`;
    }
...
// Creates buttons for a keyboard
